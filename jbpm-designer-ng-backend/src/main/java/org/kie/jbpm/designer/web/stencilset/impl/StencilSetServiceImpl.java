 ...
 */
package org.kie.jbpm.designer.web.stencilset.impl;
...
import org.kie.jbpm.designer.web.stencilset.IDiagramStencilSet;
import org.kie.jbpm.designer.web.stencilset.IDiagramStencilSetFactory;
import org.kie.jbpm.designer.web.stencilset.IDiagramStencilSetService;
...
public class StencilSetServiceImpl implements IDiagramStencilSetService {
    ...
    private void initializeLocalStencilSets(ServletContext context) {
        File ssDir = new File(context.getRealPath("designer/stencilsets"));

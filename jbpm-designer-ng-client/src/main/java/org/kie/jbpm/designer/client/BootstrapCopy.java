 ...
 * to the server with GWT-RPC\Errai-RPC to get the necessary configuration parameters.
 */
//@ApplicationScoped
public class BootstrapCopy {
    ...
    public void init() {
        ...
        //Append script tags
        appendScript( "/designer/lib/prototype-1.5.1.js" );
        appendScript( "/designer/lib/path_parser.js" );
        appendScript( "/designer/lib/ext-2.0.2/adapter/ext/ext-base.js" );
        appendScript( "/designer/lib/ext-2.0.2/ext-all.js" );
        appendScript( "/designer/lib/ext-2.0.2/color-field.js" );
        appendScript( "/designer/lib/jquery-1.7.2.min.js" );
        appendScript( "/designer/lib/handlebars-1.0.0.beta.6.js" );
        ...
        appendScript( "/designer/js/cm.js" );
        appendScript( "/designer/js/cmxml.js" );
        appendScript( "/designer/js/cmjs.js" );
        appendScript( "/designer/js/cmcss.js" );
        appendScript( "/designer/js/cmclike.js" );
        appendScript( "/designer/js/cmhtmlmixed.js" );
        appendScript( "/designer/js/closetags.js" );
        appendScript( "/designer/js/hint.js" );
        appendScript( "/designer/js/hintjbpm.js" );
        appendScript( "/designer/js/cmsearch.js" );
        appendScript( "/designer/js/cmsearchcursor.js" );
        appendScript( "/designer/js/cmdialog.js" );
        appendScript( "/designer/js/cmfold.js" );
        ...
        appendLink( head,
                    ...
                    "text/css" );
        //Chrome Frame
        appendScript( "/designer/js/CFInstall.min.js" );
        ...
        for ( String pluginFile : pluginFiles ) {
            appendScript( pluginFile );
        }

        //Oryx bootstrap
        appendScriptBlock( head,
                           "function bootstrap() {\n" +
                                   "jQuery.noConflict();\n" +
                                   ...
                                   "ORYX.CONFIG.ROOT_PATH = \"/\" + segments.first() + \"/designer/\";\n" +
    ...
    public native void addScripts( final String p0 ) /*-{
    ...
    private void appendScript( final String url ) {
        scripts.add( url );
    }

    private void appendScriptBlock( final Element element,
                                    final String source ) {
